...
ActiveRecord::Schema.define(version: 20_201_225_144_628) do
  ...
  create_table 'responses', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[respondable_type respondable_id], name: 'index_responses_on_respondable_type_and_respondable_id'
